...
multi_med_confounder = NxMixedGraph.from_edges(
    ...
    undirected=[
        ...
        # Z1 and Z2, but that bi-directed edge is missed from this prior knowledge graph.
    ],
)

multi_med_confounder_example = Example(
    name="Multi_mediators_confounders",
    reference="Causal workflow paper, figure 4. The query can be estimated with both front-door and back-door approaches",
