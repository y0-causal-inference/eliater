...
from src.eliater.examples import continuous
...
class TestWorkflow(unittest.TestCase):
    ...
    def test_fix_graph(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEqual(str(w[0].message), "The data is continuous. Either discretize and use chi-square or use "
                                                "the pearson.")
        ...
        self.assertRaises(Exception,
                          fix_graph,
                          multi_med,
                          generate_data_for_multi_med(1000),
                          "abc")
