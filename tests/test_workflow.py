...
from eliater.examples import continuous, multi_med, multi_med_confounder
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            for warning in w:
                if issubclass(warning.category, UserWarning):
                    ...
                    expected_message = "The data is continuous. Either discretize and use chi-square or use the " \
                                       "pearson."
