...
class TestRepair(unittest.TestCase):
    ...
    def test_get_space_map_for_frontdoor(self):
        ...
        actual_frontdoor_col_types = _get_state_space_map(frontdoor_data)
    ...
    def test_get_space_map_for_frontdoor_backdoor(self):
        ...
        actual_frontdoor_backdoor_col_types = _get_state_space_map(frontdoor_backdoor_data)
    ...
    def test_choose_default_test_for_discrete_data(self):
        ...
        actual_default_test = _choose_default_test(frontdoor_backdoor_data)
    ...
    def test_choose_default_test_for_mixed_data(self):
        ...
        frontdoor_data = generate_data_for_frontdoor(1000)
        self.assertRaises(NotImplementedError, _choose_default_test, frontdoor_data)
